...
$db_name = 'empm_hw_db';
$db_hw_tbl_users = 'empm_hw_users';
$db_hw_tbl_options = 'empm_hw_options';

$_SESSION['db_hw_tbl_users'] = $db_hw_tbl_users;
$_SESSION['db_hw_tbl_options'] = $db_hw_tbl_options;
...
$sql_create_tbl_options = "CREATE TABLE IF NOT EXISTS $db_hw_tbl_options (
        id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,
